...
export interface INotificationService {
  ...
  notifyStatusChanged(ticketId: string, newStatus: TicketStatus, recipientIds?: string[]): Promise<NotificationResult>;
  notifyCommentAdded(ticketId: string, commentId: string, recipientIds?: string[]): Promise<NotificationResult>;
  notifyTicketResolved(ticketId: string, recipientIds?: string[]): Promise<NotificationResult>;
